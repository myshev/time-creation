...
class ProductSubcategoryForm extends BaseProductSubcategoryForm
{
	public function configure() {
		...
		$this->widgetSchema['image'] = new sfWidgetFormInputFileEditable(array(
			'label'     => 'Image',
			'file_src'  => '/uploads/product_subcategory/thumb/'.$this->getObject()->getImage(),
			'is_image'  => true,
		...
		$this->validatorSchema['image'] = new sfValidatorFileThumb (
			array(
				'path'        => sfConfig::get('sf_upload_dir') . DIRECTORY_SEPARATOR . 'product_subcategory',
				'required'    => false,
				'mime_types'  => 'web_images',
				// Part below concerning a thumbnail
				'with_thumb'  => true,
				'thumb_path'  => sfConfig::get('sf_upload_dir') . DIRECTORY_SEPARATOR . 'product_subcategory/thumb',
				'thumb_scale' => true,
				'thumb_inflate' => true,
