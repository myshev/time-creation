...
/**
 * ProductSubcategory2Product form base class.
 *
 * @method ProductSubcategory2Product getObject() Returns the current form's model object
 *
 * @package    manymoney
 * @subpackage form
 ...
 */
abstract class BaseProductSubcategory2ProductForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('product_subcategory2_product[%s]');
