...
class NewsForm extends BaseNewsForm {
	public function configure() {
		...
		$this->widgetSchema['image'] = new sfWidgetFormInputFileEditable(array(
			'label'     => 'Image',
			'file_src'  => '/uploads/news/thumb/'.$this->getObject()->getImage(),
			'is_image'  => true,
		...
		/*$this->validatorSchema['image']	= new sfValidatorFile(
			array(
				...
				'path'			=> sfConfig::get('sf_upload_dir') . DIRECTORY_SEPARATOR . 'news',
				'required'    => false
			)
		);*/
		...
		$this->validatorSchema['image'] = new sfValidatorFileThumb (
			array(
				...
				'with_thumb'  => true,
				'thumb_path'  => sfConfig::get('sf_upload_dir') . DIRECTORY_SEPARATOR . 'news/thumb',
				'thumb_scale' => true,
				'thumb_inflate' => true,
